...
public class FacultyServiceTest {
    ...
    void testEditFaculty() {
        ...
        createdFaculty.setName("Two");
        Faculty editFaculty = facultyService.editFaculty(createdFaculty);

        assertNotNull(editFaculty);
        assertEquals("Two", editFaculty.getName());
        assertEquals(createdFaculty, editFaculty);
